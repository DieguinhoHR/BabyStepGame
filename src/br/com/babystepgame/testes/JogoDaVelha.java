...
public class JogoDaVelha {
	...
	private boolean verificaXisLinhaColuna() {		
	...
	private boolean verificaBolaLinhaColuna() {
	...
	public boolean verificaXisBola() {
		if(verificaXisLinhaColuna())
			return true;
		
		if(verificaBolaLinhaColuna())
			return true;		
